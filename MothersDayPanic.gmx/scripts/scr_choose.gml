...
entre = choose('burger','chicken','burger','chicken','burger','chicken','wings','none');
if(entre != 'none'){
    if(entre == 'wings'){
    ...
    side = choose('fries','waffle','tots','rings','none');
...
scr_set_ticket(app, entre, temp, cajun, bone_in, top1, top2, top3, top4, top5, side);
